...
exports.MAX_BATCH_SIZE = exports.DEFAULT_MAX_REQUEST_BODY_SIZE = void 0;
exports.requestBodyTooLargeMessage = requestBodyTooLargeMessage;
exports.resolveMaxRequestBodySize = resolveMaxRequestBodySize;
...
exports.DEFAULT_MAX_REQUEST_BODY_SIZE = 4 * 1024 * 1024;
...
function resolveMaxRequestBodySize(value) {
    if (value === undefined) {
        return exports.DEFAULT_MAX_REQUEST_BODY_SIZE;
    }
 ...
 */
async function readRequestBody(request, maxBytes = exports.DEFAULT_MAX_REQUEST_BODY_SIZE) {
